	...
	<div data-options="region:'center',border:false" title="" style="overflow: hidden;">
		<form id="form" method="post">
			<table class="table table-hover table-condensed">
				<tr>
					<th>编号</th>
					<td><input name="userIds" type="text" class="span2" value="${ids}" readonly="readonly"></td>
					<th>所属角色</th>
				...
				<tr>
					<th>所属中心</th>
					<td><select id="unitIds" name="unitIds" style="width: 140px; height: 29px;"></select><img src="${pageContext.request.contextPath}/style/images/extjs_icons/cut_red.png" onclick="$('#unitIds').combotree('clear');" /></td>
				</tr>
			</table>
		</form>
	</div>
