...
var easyuiErrorFunction = function(XMLHttpRequest) {
	...
	$.messager.alert('错误', XMLHttpRequest.status+XMLHttpRequest.responseText);
};
...
$.fn.dialog.defaults.onLoadError = easyuiErrorFunction;
...
$.extend($.fn.combobox.defaults, {
 ...
 var filterComboboxData =function doQuery(q, evt){
    var target = this;
    var el = $(this);
...
//       $(target).combo('setValues', vv);
 ...
 var onComboboxHidePanel = function filterComboboxData(input, row) {
     // 清空内容, 则不过滤
  ...
  var doQuery = function onComboboxHidePanel(){
     var el = $(this);
...
//	            var input = $('<input class="span2" onclick="WdatePicker({readOnly:true,dateFmt:"yyyy-MM-dd HH:mm:ss"})" readonly="readonly" />').appendTo(container);
//	            return input;
//	        },
